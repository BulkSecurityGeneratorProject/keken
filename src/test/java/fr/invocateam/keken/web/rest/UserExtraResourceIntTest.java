...
import fr.invocateam.keken.repository.search.UserExtraSearchRepository;
...
public class UserExtraResourceIntTest {
    ...
    public void setup() {
        ...
        UserExtraResource userExtraResource = new UserExtraResource(userExtraRepository, userExtraSearchRepository);
