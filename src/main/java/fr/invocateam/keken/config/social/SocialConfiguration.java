package fr.invocateam.keken.config.social;

import fr.invocateam.keken.repository.SocialUserConnectionRepository;
import fr.invocateam.keken.repository.CustomSocialUsersConnectionRepository;
import fr.invocateam.keken.security.jwt.TokenProvider;
import fr.invocateam.keken.security.social.CustomSignInAdapter;
...
public class SocialConfiguration implements SocialConfigurer {
    ...
    public void addConnectionFactories(ConnectionFactoryConfigurer connectionFactoryConfigurer, Environment environment) {
        ...
        log.debug(facebookClientId);
        log.debug(facebookClientSecret);
        ...
        log.debug(twitterClientId);
        log.debug(twitterClientSecret);
